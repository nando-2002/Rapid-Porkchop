...
def uplanet(mjd2000, ibody):
    '''
    Python re-write of uplanet.m provided by PoliMi


    Accepts the mjd2000 and index of a celestial body in the Solar System and 
    returns the keplerian elements of the body's position 
    ...
    ibody : int
        Integer number identifying the celestial body
            1:   Mercury
            2:   Venus
            3:   Earth
            4:   Mars
    ...
    Returns:
    kep : ndarray 
        Keplerian orbital elements of specific time for the specified body
        kep = [a e i Om om theta] [km, rad]

    Author:
        P. Dysli, 1977 (uplanet.m)

    Copied into Python by Prthik Karthikeyan 04/12/2025
    '''
